...
public class FileUtil {
	...
	public static String PRODUCTS_PATH = resource.getString("products.file.path").trim();
	 ...
	 */
	public static void copyFile(String resFilePath, String destFolder) throws IOException {
	 ...
	 * @IOException 当操作发生异常时抛出
	 */
	public static void moveFile(String resFilePath, String destFolder) throws IOException {
		File resFile = new File(resFilePath);
		File destFile = new File(destFolder);
		if (resFile.isDirectory()) {
	 ...
	 * @IOException 当操作发生异常时抛出
	 */
	public static void moveModifyFile(String resFilePath, String destFilePath) throws IOException {
